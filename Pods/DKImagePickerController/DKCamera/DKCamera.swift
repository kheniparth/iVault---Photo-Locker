...
public class DKCamera: UIViewController {
	...
	public func setupUI() {
		...
		contentView.addGestureRecognizer(UIPinchGestureRecognizer(target: self, action: "handleZoom"))
		contentView.addGestureRecognizer(UITapGestureRecognizer(target: self, action: "handleFocus"))
	}
